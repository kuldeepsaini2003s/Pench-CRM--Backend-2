...
router.put("/markAsRead/:notificationId",verifyDeliveryBoyToken,markNotificationAsRead);
router.delete("/deleteNotification/:notificationId", verifyDeliveryBoyToken, deleteNotification);
